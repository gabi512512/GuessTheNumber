...
**Reload button**: You can reload your previous saved game statistics, you enter your name in the pop-up dialog (you must have the save path selected on the folder from which you want to reload a save
